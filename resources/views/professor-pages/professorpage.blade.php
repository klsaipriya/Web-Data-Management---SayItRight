...
<html>
    ...
    <body id="professor-page">
        ...
        <div class="management">
            <!--<div class="element">
                <img src="manage.jpg" width="300px" height="300px">
                <p><a href="managecourse.html">MANAGE COURSEWORK</a></p>
            </div>-->
            <div class="element">
                <img src="{{asset('images/manage.jpg')}}" width="300px" height="300px">
                <p><a href="/manageyourcourses">OPEN A COURSE</a></p>
            </div>
            <div class="element">
                <img src="{{asset('images/studentprofile.jpg')}}" width="300px" height="300px">
                <p><a href="/profmanagestudents">MANAGE STUDENTS</a></p>
            </div>
            <div class="element">
                <img src="{{asset('images/hwschedule.jpg')}}" width="300px" height="300px">
                <p><a href="/profmanagestudentrecordings">MANAGE STUDENT INFORMATION</a></p>
            </div>
            <div class="element">
                <img src="{{asset('images/managegrading.png')}}" width="300px" height="300px">
                <p><a href="/managegrading">MANAGE GRADING FOR PROJECTS</a></p>
            </div>
            <div class="element">
                <img src="{{asset('images/makeannouncement.jpg')}}" width="300px" height="300px">
                <p><a href="/makeannouncements">MAKE ANNOUNCEMENTS</a></p>
            </div>
        </div>
    </body>
        </html>