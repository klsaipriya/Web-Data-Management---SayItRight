    ...
    <body>
        ...
        <table>
            ...
            <tr>
                ...
                <td>{{$user->subject}}</td>
                <td>{{$user->comments}}</td>
                <td><a href="{{url('/downloadfile',$user->filename)}}">Download</a></td>
                <td><a href="/evaluate?username={{$user->username}}&subject={{$user->subject}}&comments={{$user->comments}}">Evaluate</a></td>
            </tr>
            @endforeach
        </table>
    </body>
