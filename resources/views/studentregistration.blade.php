...
<html>
    ...
    <body>
        ...
        <div class="Register">
            ...
            <form name="registrationform" method="post" action='/studentregister' onsubmit="return formvalidation()" enctype="multipart/form-data"> 
                ...
                <label id="Register">Upload File (Name Recording) </label>
                <input type="file" name="file" id="Register"><br/>
