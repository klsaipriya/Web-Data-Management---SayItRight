...
<html>
    ...
    <body>
        ...
        <div id="profile-details">
            ...
            <form method="post" action="/adm-savecoursedetails?username={{$username}}">
            @csrf
            <p>ProfId:{{$username}}</p>
            <p>Cid:<br/><input type="text" name="cid" value="{{$cid}}"></p>
            <p>Subject:<br/><input type="text" name="subject" value="{{$subject}}"></p>
            <p>Section:<br/><input type="text" name="section" value="{{$section}}"></p>
            <p>Days:<br/><input type="text" name="days" value="{{$days}}"></p>
            <p>Fromtime:<br/><input type="text" name="fromtime" value="{{$fromtime}}"></p>
            <p>Totime:<br/><input type="text" name="totime" value="{{$totime}}"></p>
