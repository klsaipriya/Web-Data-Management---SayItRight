...
<html>
    ...
    <body>
        ...
        <form id="homework-attachement" method="post" action="/hwsubmit?subject={{$subject}}&profid={{$profid}}" enctype="multipart/form-data">
            @csrf
            <p>Subject: {{$subject}}</p>
            <p>ProfId: {{$profid}}</p>
            <input type="file" name="file"><br/><br/>
            <label>Comments</label><br/>
            <textarea value="Type here......." placeholder="Comments" name="comments"></textarea><br/><br/>
            <button type="submit" id="attachment" name="submit">SUBMIT</button>
        </form>
